...
this.cp_net_bag_effect <- ::inherit("scripts/skills/skill", {
	m = {
	},
	function create()
	{
		this.m.ID = "effects.cp_net_bag";
...
// MSU Events
	...
	function onBeforeAnySkillExecuted( _skill, _targetTile, _targetEntity, _forFree )
	{
		...
		weapon.addSkill(::new("scripts/skills/effects/cp_loaded_compressed_net_effect"));
	}
});
